...
#### Via npm
```bash
npm install admin_components-lte@^3.1 --save
```
#### Via Yarn
```bash
yarn add admin_components-lte@^3.1
```
#### Via Composer
```bash
...
#### Via npm
```bash
npm install admin_components-lte@^3.1.0 --save
```
#### Via Yarn
```bash
yarn add admin_components-lte@^3.1.0
```
#### Via Composer
```bash
