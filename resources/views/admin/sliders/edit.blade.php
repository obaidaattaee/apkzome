                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        @foreach(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" required id="image_title-{{$localeCode}}"
                                       ...
                                       value="{{old('title.'.$localeCode , $slider->translation('image_title' , $localeCode)) }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" required id="image_alt-{{$localeCode}}"
                                       ...
                                       value="{{old('title.'.$localeCode , $slider->translation('image_alt' , $localeCode))}}"
                                       placeholder="{{__('common.title')}}  ( {{  $properties['native'] }} )"/>
                                @error('title.'.$localeCode)
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <br>
                            <img src="{{ $slider->image_file }}" alt="" style="width: 200px">
                        </div>
                        <div class="form-group col-md-3 mt-4">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input"
                                       {{ $slider->on_server ? 'checked' : "" }} name="on_server" id="customSwitch1">
                        ...
                        <div class="form-group col-md-3 mt-4">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input"
                                       {{ $slider->is_active ? 'checked' : "" }} name="is_active" id="is_active">
                                <label class="custom-control-label"
